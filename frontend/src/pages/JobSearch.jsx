...
import { Search, MapPin, Filter, RotateCcw, ArrowUpDown } from 'lucide-react';
      ...
      <main className="main-content" style={{ padding: '2rem 0' }}>
        <div className="container-xl">
          ...
          <div className="card" style={{ marginBottom: '2rem', background: 'var(--surface-white)' }}>
            <form onSubmit={handleSearchSubmit} style={{ display: 'grid', gridTemplateColumns: '2fr 1.5fr 1fr auto', gap: '1rem', alignItems: 'center' }}>
